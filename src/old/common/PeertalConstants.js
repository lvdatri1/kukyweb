...
const CONSTANTS = {
  ...
  DEFAULT_AVATAR:
    'https://s3-ap-southeast-2.amazonaws.com/test.kuky.com/media/default-avatar.png',
  DEFAULT_VIDEO_ICON:
    'https://s3-ap-southeast-2.amazonaws.com/test.kuky.com/media/video_player.png',
  DEFAULT_BG:
    'https://s3-ap-southeast-2.amazonaws.com/test.kuky.com/media/side_bg.png',
