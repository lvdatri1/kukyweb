...
import RadioButton from "../components/CoreUIComponents/RadioButton";
import { addACard } from "../actions/userActions";

class LinkCreditCardScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
          ...
          <ScrollView style={{ marginHorizontal: 15 }}>
            ...
            <View>
              <TextInput
                ...
                onChangeText={value => this.setState({ cardHolderName: value })}
              />
            </View>
            <View style={styles.lineContainer}>
              <Icon
                ...
                style={{ ...styles.iconStyle }}
              />
              <Text style={{ ...styles.textCaption }}>Card Holder Number</Text>
            </View>
            <View>
              <TextInput
                style={{ ...styles.inputContainer }}
...
const LinkCreditCardContainer = connect(mapStateToProps)(LinkCreditCardScreen);
export default LinkCreditCardContainer;
