...
class SendMoneyRequestScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentStep: 1,
  ...
  handleSendMoney() {
    ...
    const requestData = { amount: amount, tags: tags, reason: reason };
...
export default (SendMoneyRequestContainer = connect(MapStateToProps)(
  SendMoneyRequestScreen
));
const styles = {
  step: {
    marginVertical: 40,
